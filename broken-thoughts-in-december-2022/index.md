...
简单介绍一下这位大佬George Hotz，破解苹果手机出名，在Google，Facebook任职过，然后创办自动驾驶公司，最近又跑到Twitter去干实习生了😂，直播内容是Twitter逆向工程。

以下是视频中的场景：

1. 记不清或不懂的地方也会去翻文档。
2. 遇到解决不了的问题也会Google，然后一顿Ctrl C + Ctrl V。😁
3. 也会一边自言自语，哼哼小曲～，一边敲代码。
4. 程序运行不起来，也会发出oh no，wtf等词语，当程序跑通后，又暗暗惊喜，手舞足蹈起来。
